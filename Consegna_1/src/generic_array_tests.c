...
//il numero di elementi del array appena creato dovrà essere zero
  ...
  GenericArray *ordered_array_int = generic_array_create(precedes_int); // creo un array
  TEST_ASSERT_TRUE(generic_array_is_empty(ordered_array_int));
  generic_array_free_memory(ordered_array_int); // libero l'array dalla memoria 
}

    static void test_ordered_array_is_empty_one_el() {
    int i = -12;
    GenericArray *ordered_array_int = generic_array_create(precedes_int);
    generic_array_add(ordered_array_int, &i);   // aggiungo l'elemento 
    TEST_ASSERT_FALSE(generic_array_is_empty(ordered_array_int));
    generic_array_free_memory(ordered_array_int);
}

  static void test_ordered_array_size_zero_el() {
    GenericArray *ordered_array_int = generic_array_create(precedes_int);
    TEST_ASSERT_EQUAL_INT(0, generic_array_size(ordered_array_int));
    generic_array_free_memory(ordered_array_int);
}
    ...
    int i1 = -12;
    GenericArray *ordered_array_int = generic_array_create(precedes_int);
    generic_array_add(ordered_array_int, &i1);
    TEST_ASSERT_EQUAL_INT(1, generic_array_size(ordered_array_int));
    generic_array_free_memory(ordered_array_int);
}
    ...
    GenericArray *ordered_array_int = generic_array_create(precedes_int);
    generic_array_add(ordered_array_int, &i1);
    generic_array_add(ordered_array_int, &i2);
    TEST_ASSERT_EQUAL_INT(2, generic_array_size(ordered_array_int));
    generic_array_free_memory(ordered_array_int);
}
...
static void test_ordered_array_add_get_one_el() {
  ...
  GenericArray *ordered_array_int = generic_array_create(precedes_int);
  generic_array_add(ordered_array_int, &i1);
  TEST_ASSERT_EQUAL_PTR(&i1, generic_array_get(ordered_array_int, 0)); // asserische che i puntatori puntino nella stessa posizione di memoria
  generic_array_free_memory(ordered_array_int);
}
...
static void test_ordered_array_add_get_three_el() {
  ...
  GenericArray *ordered_array_int = generic_array_create(precedes_int);
  generic_array_add(ordered_array_int, &i2);
  generic_array_add(ordered_array_int, &i3);
  generic_array_add(ordered_array_int, &i1);
  sorting_algorithm(ordered_array_int, precedes_int, 0, generic_array_size(ordered_array_int) - 1);

  int **act_arr = malloc(3*sizeof(int*));
  for (unsigned long i=0; i < 3; ++i) {
    act_arr[i] = (int*)generic_array_get(ordered_array_int, i);
  }
...
static void test_sorting_algorithm(){
    ...
    GenericArray *ordered_array_int = generic_array_create(precedes_int);
    generic_array_add(ordered_array_int, &i4);
    generic_array_add(ordered_array_int, &i2);
    generic_array_add(ordered_array_int, &i1);
    generic_array_add(ordered_array_int, &i5);
    generic_array_add(ordered_array_int, &i3);
    sorting_algorithm(ordered_array_int,precedes_int, 0, generic_array_size(ordered_array_int) - 1);
    TEST_ASSERT_EQUAL_PTR(&i2,generic_array_get(ordered_array_int, 0));
    TEST_ASSERT_EQUAL_PTR(&i1,generic_array_get(ordered_array_int, 1));
    TEST_ASSERT_EQUAL_PTR(&i3,generic_array_get(ordered_array_int, 2));
    TEST_ASSERT_EQUAL_PTR(&i5,generic_array_get(ordered_array_int, 3)); 
    TEST_ASSERT_EQUAL_PTR(&i4,generic_array_get(ordered_array_int, 4));
    generic_array_free_memory(ordered_array_int);
}
...
static void test_algorithm_equal_two_elements(){
    ...
    generic_array_add(ordered_array_int, &i3);
    sorting_algorithm(ordered_array_int,precedes_int, 0, generic_array_size(ordered_array_int) - 1);
    TEST_ASSERT_EQUAL_PTR(&i1,generic_array_get(ordered_array_int, 0));
    TEST_ASSERT_EQUAL_PTR(&i3,generic_array_get(ordered_array_int, 1));
    TEST_ASSERT_EQUAL_PTR(&i2,generic_array_get(ordered_array_int, 2));
    TEST_ASSERT_EQUAL_PTR(&i5,generic_array_get(ordered_array_int, 3)); 
    TEST_ASSERT_EQUAL_PTR(&i4,generic_array_get(ordered_array_int, 4));
    generic_array_free_memory(ordered_array_int);
}
...
static void test_algorithm_equal_three_elements(){
    ...
    TEST_ASSERT_EQUAL_PTR(&i3,generic_array_get(ordered_array_int, 1));
    TEST_ASSERT_EQUAL_PTR(&i2,generic_array_get(ordered_array_int, 2));
    TEST_ASSERT_EQUAL_PTR(&i4,generic_array_get(ordered_array_int, 3)); 
    TEST_ASSERT_EQUAL_PTR(&i5,generic_array_get(ordered_array_int, 4));
    generic_array_free_memory(ordered_array_int);
}
